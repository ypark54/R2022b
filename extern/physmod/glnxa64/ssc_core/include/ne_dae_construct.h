...
NE_MB_LOCAL_SOLVER_ODE1,NE_MB_LOCAL_SOLVER_ODE2,NE_MB_LOCAL_SOLVER_NUM}
NeMBLocalSolverChoice;struct NeSolverParametersTag{boolean_T mUseMBLocalSolver
;NeMBLocalSolverChoice mMBLocalSolverChoice;real_T mMBLocalSolverSampleTime;
