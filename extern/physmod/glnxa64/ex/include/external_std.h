...
const boolean_T intrpMthd,const boolean_T extrpMthd);boolean_T
collinearcheck_2d(const real_T*inputPtsAndVal,const size_t numPts);boolean_T
coplanarcheck_3d(const real_T*inputPtsAndVal,const size_t numPts);
#ifdef __cplusplus
}
#endif /* __cplusplus */
